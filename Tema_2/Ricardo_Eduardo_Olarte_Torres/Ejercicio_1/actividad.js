...
function redConverter() {
  let outputPath = "output/tucan_red.jpg"; //Ancho = 1280px y Alto = 838px
...
function merge(alphaFirst, alphaSecond) {
  ...
  for (let i = 0; i < catPixels.length; i++) {
    ...
    for (let j = 0; j < catPixels[i].length; j++) {
      catPixels[i][j][0] =
        dogPixels[i][j][0] * alphaFirst + catPixels[i][j][0] * alphaSecond;
      catPixels[i][j][1] =
        dogPixels[i][j][0] * alphaFirst + catPixels[i][j][1] * alphaSecond;
      catPixels[i][j][2] =
        dogPixels[i][j][0] * alphaFirst + catPixels[i][j][2] * alphaSecond;
    }
  }
